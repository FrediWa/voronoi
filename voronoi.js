...
function instantiateArrayBuffer(binaryFile, imports, receiver) {
  return getBinaryPromise(binaryFile).then(function(binary) {
    return WebAssembly.instantiateStreaming(binary, imports);
...
var ASM_CONSTS = {
 ...
 65496: ($0) => { if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } },  
 65579: () => { if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; } },  
 65648: () => { return window.innerWidth; },  
 65678: () => { return window.innerHeight; }
};
